      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 lg:grid-cols-[1fr_0.95fr] lg:gap-16">
        ...
        >
          ...
          <h2 className="mt-6 max-w-xl font-display text-3xl font-bold leading-[1.08] tracking-tight md:text-4xl lg:text-5xl">
            Request trade pricing for ready-made curtains.
          </h2>
          ...
          <p className="mt-5 max-w-lg text-base leading-7 text-white/70 md:text-lg">
            ...
            wholesale pricing, MOQs and lead times. No obligation — we reply
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a
              ...
              className="group inline-flex items-center justify-center gap-2.5 rounded-full border border-white/15 bg-white/5 px-7 py-4 text-base font-bold text-white backdrop-blur-md transition-all duration-300 hover:border-[#25D366]/60 hover:bg-white/10"
            >
        ...
        >
          <FormPanel
            ...
            subheading="Ready-made curtains · No obligation · Reply within 1 business day."
          />
        </motion.div>
      </div>
    </section>
